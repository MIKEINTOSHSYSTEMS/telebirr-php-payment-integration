...
<head>
    ...
    <title>Telebirr Payment Demo</title>
    <link rel="stylesheet" href="assets/css/style.css">
    <style>
        .debug-info { background: #f8f9fa; border: 1px solid #dee2e6; padding: 15px; margin: 20px 0; border-radius: 8px; font-family: monospace; font-size: 12px; max-height: 400px; overflow: auto; }
        .debug-info pre { margin: 0; white-space: pre-wrap; }
        .raw-request { background: #1e1e1e; color: #d4d4d4; padding: 15px; border-radius: 8px; font-family: monospace; font-size: 12px; overflow: auto; margin-top: 10px; }
